...
const TickerItem = ({ bolao }: { bolao: Bolao }) => (
  <div className="flex items-center gap-3 text-sm mx-4 whitespace-nowrap">
...
export const ResultsTicker = () => {
  ...
  if (loading) {
    return <Skeleton className="h-6 w-full max-w-lg" />;
  }
  ...
  const animationDuration = results.length * 7; 
